...
void init_pml_parameter( GRID grid, MPI_BORDER border, PML_ALPHA pml_alpha, PML_BETA pml_beta, PML_D pml_d );
...
void loadPointSource( SOURCE S, WAVE h_W, int NX, int NY, int NZ, float * Jac, int it, int iRK, float DT, float DH );
